...
public class Simplex {
    ...
    public Simplex(double[][] A, double[] price, double[] source){
        this.A = A;
        this.price = price;
        this.source = source;
        m = A.length;
    ...
    private void updateVectors() {
        ...
        for (int i = 0; i < m; i++) {
            ...
            if(i != idxOfOut){
                ...
                source[i] -= source[idxOfOut] * temp1;
            }
        }
    ...
    private void printOptimum() {
        result = 0;
        for (int i = 0; i < basedVar.length; i++) {
            result += price[basedVar[i]-1] * source[i];
        }
